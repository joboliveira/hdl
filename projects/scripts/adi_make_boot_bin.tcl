...
# 2 - uboot.elf file location/name (default: ./uboot.elf)
...
# Examples:
# - create_boot_bin.tcl
# - create_boot_bin.tcl $hdf_path/system_top.hdf $uboot_path/uboot.elf
# - create_boot_bin.tcl $hdf_path/system_top.hdf $uboot_path/uboot.elf $workspace
# - create_boot_bin.tcl $hdf_path/system_top.hdf $uboot_path/uboot.elf $workspace $arm_trf_repo/bl31.elf
